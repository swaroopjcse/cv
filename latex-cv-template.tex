...
\usepackage{sectsty}
\subsectionfont{\rmfamily\mdseries\large\bf}
...
\fancypagestyle{firstpage}
{
  ...
  \fancyfoot[L]{\scriptsize \emph{Updated: }\apstylekinda\today}%
  \fancyfoot[R]{\scriptsize \thepage/{\hypersetup{linkcolor=black}\pageref{LastPage}}}
}
