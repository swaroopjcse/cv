...
\printbibliography[title=Dissertations, keyword={thesis}]
\printbibliography[title=Other Publications, keyword={tr}]
%%------------------------------------------------------------------------------
% \section{Skills}
...
% \cventry{2016}{Volunteer}{Buck-i-code}{ACM-W, OSU}{}{Association for Computing
  % and Machinery - Women's OSU chapter organized a day-long workshop Buck-i-Code
  % in Spring 2016, targeted at school-going female students to get them
  % interested in computer science at a young age. I was one of the volunteers who
  % helped them with their lab sessions, as well as registrations.}%
...
\cventry{Mar.\ 2018}{Research Paper Judge}{Hayes Graduate Research
  Forum}{OSU}{}{}%
\cventry{Mar.\ 2015}{Research Poster Judge}{Denman Undergraduate Research
  Forum}{OSU}{}{}%
\cventry{2015---}{Graduate Representative}{Mobile Governance}{OSU}{}{Mobile
  Governance initiative at OSU is a collaborative effort between OCIO, TCO, and
  other stakeholders at OSU to ensure the large number of mobile and web
  applications developed by various departments at OSU (e.g.\ medical center)
  meet the quality and branding standards of the university. I am part of this
  initiative as a CSE graduate student representative since April 2015. My role
  includes participating in regular meetings and communicating with the capstone
  course coordinators in the CSE department to ensure any product coming out of
  their course does not violate the university guidelines.}%
